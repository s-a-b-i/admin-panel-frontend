...
const SearchAddSection = ({ searchTerm, setSearchTerm, onAddSupervisor }) => {
  return (
    <motion.div
    ...
    >
      <div className="relative flex-grow w-full sm:w-auto mb-4 sm:mb-0">
        <input 
          ...
          className="w-full p-3 pl-10 border rounded-lg shadow-sm bg-gray-50 border-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        />
